...
class AuthService {
    ...
    static func login(email: String, password: String, completion: @escaping (Result<LoginRes, NetworkError>) -> Void) {
        ...
        guard let url = URL(string: "https://apis.carevoiceos.com/api/app/auth/login") else {
    ...
    static func signup(email: String, password: String, completion: @escaping (Result<Bool, NetworkError>) -> Void) {
        ...
        guard let url = URL(string: "https://apis.carevoiceos.com/api/app/auth/register") else {
            completion(.failure(.invalidURL))
            return
        }
